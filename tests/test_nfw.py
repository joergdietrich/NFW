...
class TestNFW(TestCase):
    ...
    def test_mass_init(self):
        ...
        assert_almost_equal(nfw.r_s.value, 0.374162, 3)
    ...
    def test_radius_Delta(self):
        ...
        assert_almost_equal(r200.value, 1.870811, 6)
        r500 = nfw.radius_Delta(500)
        assert_almost_equal(r500.value, 1.236665, 6)
        r2500 = nfw.radius_Delta(2500)
        assert_almost_equal(r2500.value, 0.554511, 6)
    ...
    def test_density(self):
        ...
        assert_almost_equal(rho.value/1e13, 2.623190, 6)
    ...
    def test_mean_density(self):
        ...
        assert_almost_equal(rho.value/1e13, 9.221492, 6)
    ...
    def test_mess(self):
        ...
        nfw = NFW(m200, c, z)
        m = nfw.mass(1.32)
        assert_almost_equal(m.value/1e14, 7.6282136906654214, 6)
    ...
    def test_sigma(self):
        ...
        nfw = NFW(m200, c, z)
        s = nfw.sigma(1.12)
        assert_almost_equal(s.value/1e13, 8.403954902419617, 6)
    ...
    def test_delta_sigma(self):
        ...
        assert_almost_equal(ds.value/1e14, 1.381662, 6)
